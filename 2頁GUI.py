...
class Window1(tk.Frame):
    ...
    #Build Object/建立物件
        ...
        self.btn2 = tk.Button(self, height=6, width=32, text="Btn2", command= self.run_secondpage) # 觸發視窗
...
class Window2(tk.Frame):
    ...
    # 期間細項
        ...
        self.btn3 = tk.Button(self, height=6, width=32, text="Btn3", command= self.run_mainpage) # 觸發視窗
    ...
    #期間細項
        ...
        self.btn3.grid(row=15, column=15, sticky=tk.S)
