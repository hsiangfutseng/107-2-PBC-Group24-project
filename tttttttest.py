...
try:
    ...
    class Window1(tk.Frame):
        ...
        def run_btn1(self):
            ...
            self.coname = tk.Label(self, height=1, width=35, bg='lightgray', text="\t\t\t\t\t\tghhfhfg")
            ...
            self.bar_chart.create_image(200, 300, image = self.imageMain,anchor = tk.NW) # anchor 設定顯示位置
    ...
    class Window3(tk.Frame):
        ...
        def create_widgets3(self):
            font1 = tkFont.Font(size=24, family='CourierNew')
            # Build Object/建立物件
            self.err = tk.Label(self, height=2, width=16,Text='keep trying',font=font1)
            self.err.grid(row=0, column=0, sticky=tk.NW)
    mainpage.destroy()
    errorpage = Window3()
    errorpage.master.title("mainpage")
    errorpage.mainloop()