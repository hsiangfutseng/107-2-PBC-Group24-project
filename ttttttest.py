    ...
    def get_crawler(self):
        ...
        for company in companys:
            ...
            browser.find_element_by_xpath(
                "/html[1]/body[1]/table[2]/tbody[1]/tr[1]/td[3]/table[1]/tbody[1]/tr[1]/td[1]/table[1]/tbody[1]/tr[1]/td[1]/table[1]/tbody[1]/tr[1]/td[1]/nobr[1]/a[1]").click()
            time.sleep(3)
            soup = BeautifulSoup(browser.page_source, 'html.parser')
...
class Window1(tk.Frame):
    ...
    #Build Object/建立物件
        ...
        self.company_name = tk.Label(self, height=2, width=29, bg='lightsteelblue', text="公司名稱",font=font1)
    ...
    def run_btn1(self):
        ...
        self.company_name.grid(row=3, column=0, sticky=tk.W)
        self.blank1.grid(row=4, column=0, sticky=tk.W)
        self.bar_chart.grid(row=5, column=0, sticky=tk.NW+tk.SE)
        self.blank2.grid(row=6, column=0, sticky=tk.W)
        self.rank.grid(row=7, column=0, rowspan=5, sticky=tk.W)
        self.fin_structure.grid(row=7, column=0, sticky=tk.NW)
        self.profitability.grid(row=9, column=0, sticky=tk.W)
...
class Window2(tk.Frame):
    ...
    # 左邊標題
        self.common_item = tk.Label(self, height=7, width=10, bg='silver', text="常見\n指標")
        self.financial_structure = tk.Label(self, height=2, width=10, bg='lightgray', text="財務\n結構")
        ...
        self.profit_capability = tk.Label(self, height=5, width=10, bg='silver', text="獲利\n能力")
        self.cashflow = tk.Label(self, height=3, width=10, bg='lightgray', text="現金\n流量")
    ...
    # 細項指標
        ...
        self.index7 = tk.Label(self, height=1, width=70, bg='LightSalmon', text="本益比")
        ...
        self.index23 = tk.Label(self, height=1, width=70, bg='LightSalmon', text="每股盈餘(元)")
    ...
    # 產業細項
        self.industry1 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list1[0])
        self.industry2 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list1[1])
        self.industry3 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list1[2])
        self.industry4 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list1[3])
        self.industry5 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list1[4])
        self.industry6 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list1[5])
        self.industry7 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list1[6])
        self.industry8 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list1[7])
        self.industry9 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list1[8])
        self.industry10 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list1[9])
        self.industry11 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list1[10])
        self.industry12 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list1[11])
        self.industry13 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list1[12])
        self.industry14 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list1[13])
        self.industry15 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list1[14])
        self.industry16 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list1[15])
        self.industry17 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list1[16])
        self.industry18 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list1[17])
        self.industry19 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list1[18])
        self.industry20 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list1[19])
        self.industry21 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list1[20])
        self.industry22 = tk.Label(self, height=1, width=10, bg='LightSalmon',  text=mainpage.list1[21])
        self.industry23 = tk.Label(self, height=1, width=10, bg='LightSalmon',  text=mainpage.list1[22])
        self.industry24 = tk.Label(self, height=1, width=10, bg='bisque',  text=mainpage.list1[23])
        self.industry25 = tk.Label(self, height=1, width=10, bg='bisque',  text=mainpage.list1[24])
        self.industry26 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list1[25])
    # 期間細項
        self.period1 = tk.Label(self, height=1, width=10, bg='LightSalmon',  text=mainpage.list2[0])
        self.period2 = tk.Label(self, height=1, width=10, bg='LightSalmon',  text=mainpage.list2[1])
        self.period3 = tk.Label(self, height=1, width=10, bg='LightSalmon',  text=mainpage.list2[2])
        self.period4 = tk.Label(self, height=1, width=10, bg='LightSalmon',  text="NA")
        self.period5 = tk.Label(self, height=1, width=10, bg='LightSalmon',  text=mainpage.list2[3])
        self.period6 = tk.Label(self, height=1, width=10, bg='LightSalmon',  text=mainpage.list2[4])
        self.period7 = tk.Label(self, height=1, width=10, bg='LightSalmon',  text=mainpage.list2[5])
        self.period8 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list2[6])
        self.period9 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list2[7])
        self.period10 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list2[8])
        self.period11 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list2[9])
        self.period12 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list2[10])
        self.period13 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list2[11])
        self.period14 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list2[12])
        self.period15 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list2[13])
        self.period16 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list2[14])
        self.period17 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list2[15])
        self.period18 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list2[16])
        self.period19 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list2[17])
        self.period20 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list2[18])
        self.period21 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list2[19])
        self.period22 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list2[20])
        self.period23 = tk.Label(self, height=1, width=10, bg='LightSalmon', text=mainpage.list2[21])
        self.period24 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list2[22])
        self.period25 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list2[23])
        self.period26 = tk.Label(self, height=1, width=10, bg='bisque', text=mainpage.list2[24])
    ...
    # 左邊標題
        ...
        self.financial_structure.grid(row=11, column=0, rowspan=2, sticky=tk.NE +tk.SW)
        ...
        self.profit_capability.grid(row=22, column=0, rowspan=5, sticky=tk.NE +tk.SW)
        self.cashflow.grid(row=27, column=0, rowspan=3, sticky=tk.NE +tk.SW)
    ...
    def run_mainpage(self):
        self.destroy()
        mainpage2 = Window3()
        mainpage2.master.title("mainpage")
        mainpage2.mainloop()
