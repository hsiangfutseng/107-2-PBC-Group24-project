...
class Crawel():
    ...
    def get_crawler(self):
        ...
        browser = webdriver.Chrome('C:\\Users\\madis\\AppData\\Local\\Programs\\Python\\Python37\\chromedriver')
...
class Window1(tk.Frame):
    ...
    #Build Object/建立物件
        ...
        self.bar_chart = tk.Canvas(self, width = 300, height = 200, bg = "white")
        ...
        self.btn1 = tk.Button(self, height=4, width=32, text="ENTER")
        self.btn2 = tk.Button(self, height=3, width=16, text="NEXT PAGE") # 觸發視窗
    ...
    def makeBarchart(self):
        ...
        pyplot.savefig(locationForBarchart, dpi = 30) # dpi太多會爆
...
"""
    ...
    def run_btn1(self):
        ...
        self.blank1 = tk.Label(self, height=2, width=48, text="")
        self.bar_chart = tk.Canvas(self, width = 300, height = 100, bg = "white")
        self.blank2 = tk.Label(self, height=2, width=48, text="")
